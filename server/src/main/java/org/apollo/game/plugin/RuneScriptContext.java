...
/**
 * The {@link RuneScriptContext} contains methods a plugin can use to interface with the server, for example, by adding
 * {@link MessageHandler}s to {@link MessageHandlerChain}s.
 *
 * @author Graham
 * @author Major
 */
public final class RuneScriptContext {
	 ...
	 */
	public RuneScriptContext(ServerContext context) {
