...
public final class Release377 extends Release {
	...
	private void init() {
		...
		register(PlaySongMessage.class, new PlaySongMessageEncoder());
		register(PlaySoundMessage.class, new PlaySoundMessageEncoder());
		register(OpenTutorialDialogueInterfaceMessage.class, new OpenTutorialDialogueInterfaceMessageEncoder());
	}
