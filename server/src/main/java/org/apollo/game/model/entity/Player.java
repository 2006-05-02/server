...
import nulled.runescript.EventRegistry;
...
public final class Player extends Mob {
	...
	public boolean allowdesign = false;
	...
	public int getInteractionIndex() {
		return getUID() | 0x8000; // TODO magic constant
	}
	...
	/**
	 * Sends the initial messages. TODO: Move to RuneScript
	 */
	public void sendInitialMessages() {
		updateAppearance();
		send(new IdAssignmentMessage(uid, members));
		EventRegistry.INSTANCE.login(this);
	}
	...
	public boolean canDesign = false;
