...
enum class Emote(val button: Int, animation: Int) {
    ...
    BLOW_KISS_EMOTE(button = 11100, animation = 1368),
    ...
    GOBLIN_BOW_EMOTE(button = 13383, animation = 2127),
    GOBLIN_DANCE_EMOTE(button = 13384, animation = 2128),
    HEAD_BANG_EMOTE(button = 13365, animation = 2108),
    JIG_EMOTE(button = 13363, animation = 2106),
    JOY_JUMP_EMOTE(button = 13366, animation = 2109),
    LAUGH_EMOTE(button = 170, animation = 861),
    LEAN_EMOTE(button = 6_506, animation = 1129),
    NO_EMOTE(button = 169, animation = 856),
    PANIC_EMOTE(button = 3362, animation = 2105),
    RASPBERRY_EMOTE(button = 13367, animation = 2110),
    SALUTE_EMOTE(button = 13369, animation = 2112),
    SHRUG_EMOTE(button = 13370, animation = 2113),
    SPIN_EMOTE(button = 13364, animation = 2107),
    THINKING_EMOTE(button = 162, animation = 857),
    WAVE_EMOTE(button = 163, animation = 863),
    YAWN_EMOTE(button = 13368, animation = 2111),
